 ...
 *
 * Suckless Terminal: git clone git://git.suckless.org/st
 *
 */
 ...
 */
static char *font = "RobotoMono Nerd Font:pixelsize=16:style=Bold:antialias=true:autohint=true";
static char *font2[] = { "Inconsolata for Powerline:pixelsize=16:style=Bold:antialias=true:autohint=true" };
